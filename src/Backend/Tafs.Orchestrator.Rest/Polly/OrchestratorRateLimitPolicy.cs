//
//  OrchestratorRateLimitPolicy.cs
//
//  Author:
...
using Tafs.Orchestrator.Rest.API;

namespace Tafs.Orchestrator.Rest.Polly
{
    /// <summary>
    /// Represents an Orchestrator rate limiting policy.
    /// </summary>
    internal class OrchestratorRateLimitPolicy : AsyncPolicy<HttpResponseMessage>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrchestratorRateLimitPolicy"/> class.
        /// </summary>
        private OrchestratorRateLimitPolicy()
        {
        ...
        )
        {
            ...
            if (!RateLimitBucket.TryParse(response.Headers, endpoint, out var newLimits))
            {
                return response;
            }
        ...
        public static OrchestratorRateLimitPolicy Create() => new();
    }
}
